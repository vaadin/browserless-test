 ...
 * after the component-owned action runs innermost, flush the state tree via
 * {@link BrowserlessDSL#roundTrip}. Replaces the explicit {@code roundTrip()}
 * calls the legacy testers made at every action boundary.
 */
final class RoundTripInterceptor implements CapabilityInterceptor {
