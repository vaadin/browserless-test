...
/**
 * View that binds a session-scoped local signal, used to reproduce
...
public class ReproView extends Div {
    ...
    public ReproView(Prefs prefs) {
        // Resolve the session-scoped signal once. With per-user request-context
        // binding this is the active user's own session signal; without it the
